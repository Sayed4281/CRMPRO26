        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(child: _buildLabeledTextField('Customer Name')),
                  const SizedBox(width: 16),
                  Expanded(child: _buildLabeledTextField('Product Name')),
                ],
              ),
              ...
              Row(
                children: [
                  Expanded(child: _buildLabeledTextField('Quantity')),
                  const SizedBox(width: 16),
                  Expanded(
