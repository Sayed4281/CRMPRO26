...
class  QualifiedLeadsScreen extends StatefulWidget {
  const QualifiedLeadsScreen({super.key});

  @override
  _QualifiedLeadsScreenState createState() => _QualifiedLeadsScreenState();
}

class _QualifiedLeadsScreenState extends State<QualifiedLeadsScreen> {
